...
function setup() {
  ...
  feedbackColor = color(50); // 初期色を設定
  
  inputField = createElement('textarea', '');
  inputField.position(width/2 - 200, 160); // 画面中央に配置
  ...
  submitBtn.position(width/2 - 100, 280);
...
function checkAnswer() {
  ...
  if (syncRate >= 60) {
    ...
    feedbackColor = color(46, 204, 113);
    showAnswer = true;
